...
"%ANALYZE%" vault.luau git\init.luau git\i18n.luau git\projects.luau git\parse.luau git\header.luau git\footer.luau git\commits.luau git\branches.luau git\sync.luau git\decorations.luau git\settings.luau git-hygiene\init.luau git-hygiene\types.luau git-hygiene\i18n.luau git-hygiene\query.luau git-hygiene\scan.luau git-hygiene\footer.luau git-hygiene\picker.luau git-hygiene\settings.luau session\init.luau community-themes\init.luau telescope\init.luau telescope\fs.luau telescope\projects.luau telescope-files\init.luau harpoon\init.luau mise\init.luau telescope-grep\init.luau telescope-todos\init.luau plugins.registry.luau
